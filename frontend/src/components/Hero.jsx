...
// Social platforms with brand SVG glyphs (kept minimal, brutalist)
const SOCIALS = [
  {
    id: HERO.socialDiscord,
    key: "discord",
    label: "Discord",
    href: "https://discord.gg/quEGjqWrT",
    color: "#5865F2",
  ...
  {
    id: HERO.socialTwitch,
    key: "twitch",
    label: "Twitch",
    href: "https://www.twitch.tv/greekgodberry",
    color: "#9146FF",
  ...
  {
    id: HERO.socialYoutube,
    key: "youtube",
    label: "YouTube",
    href: "https://www.youtube.com/@greekgodberry",
    color: "#FF0000",
  ...
  },
  {
    ...
    key: "instagram",
    label: "Instagram",
    href: "https://www.instagram.com/greekgodberry/?hl=en",
    color: "#E1306C",
  ...
  },
  {
    ...
    key: "x",
    label: "X / Twitter",
    href: "https://x.com/greekgodberryx",
    color: "#ffffff",
...
// Deterministic tile positions for background icon grid (percent of container)
const BG_TILES = [
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Moving background of social icons */}
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }} aria-hidden>
        {BG_TILES.map((t, i) => {
          ...
          return (
            ...
            >
              <svg viewBox="0 0 24 24" width="55%" height="55%" fill={s.color} aria-hidden>
                {s.svg}
              </svg>
            </div>
          );
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 pt-6 pb-24 md:pt-10 grid grid-cols-1 md:grid-cols-3 gap-6" style={{ zIndex: 5 }}>
        {/* Left mythology-style copy block */}
