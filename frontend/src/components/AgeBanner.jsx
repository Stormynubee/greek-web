...
export default function AgeBanner() {
  ...
  return (
    <div
      ...
      className="age-banner fixed bottom-0 inset-x-0 z-50 bg-[#da291c] text-[#e8e4d9] border-t-4 border-black"
    >
      <div className="age-banner-content code-sequence max-w-[1400px] mx-auto px-4 py-2 flex items-center gap-3 text-xs sm:text-sm">
